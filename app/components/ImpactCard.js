export default function ImpactCard({ impact, index }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Icon */}
        <div className="w-[50px] h-[50px] md:w-[60px] md:h-[60px] rounded-full bg-dark-green md:bg-main-bg flex items-center justify-center">
          <span className="text-2xl md:text-[30px] lg:text-[36px]">{icon}</span>
        </div>

        {/* Title */}
        <h3 className="font-semibold text-[22px] lg:text-[24px] 2xl:text-[30px] lg:text-nowrap mt-2">
          {title}
        </h3>
