...
export default function TestimonialCard({ testimonial }) {
  ...
  return (
    <div className="shadow-[0_0_4px_0_#00000040] w-full h-[23rem] xl:w-[24.5rem] xl:h-[25rem]  bg-white rounded-lg py-3 px-1 xl:p-3 relative ">
      {/* Stars */}
      <div className=" absolute left-[1.5rem] md:left-[3.5rem] top-[3.8rem] xl:top-[5.8rem] flex items-center gap-1">
      ...
      <p className="absolute left-[1.5rem] md:left-[3.5rem] font-bold font-satoshi text-base top-[6rem] xl:top-[8.8rem] italic text-testimonialText mt-3 pr-[1rem] md:pr-[3rem]">
        {text}
      </p>

      {/* Author */}
      <div className=" w-[100%] absolute left-[1.5rem] md:left-[3.5rem] bottom-[1.5rem] flex gap-3 mt-4">
